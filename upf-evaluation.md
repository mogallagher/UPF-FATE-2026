# <img src="upf_logo.png" align="right" width="80"/>Rules for FATE Labs (2026)

## 1. Grades

Each practice notebook will be graded out of 10 points.

To obtain a grade in the practical session, simply deliver your work within the deadline. Not delivering your work means a zero grade in that session, unless there is justification.
...
:rage: Do not copy the work of your peers. While you may work with others to prevent simple mistakes, this does not warrant copying code.
...
It is not mandatory to attend practice sessions, although it is encouraged.

## 2. Guidelines for submitting your work

Each practice session and assignment specifies what you should deliver.

#### 2.1. Delivering your notebook

Each submission should include the following information at the top of the notebook:
...
**Be precise:** When referring to a specific question, plot, or table in your answer, be specific: which question, which plot, which table? Do not include ambiguous statements or plots without a scale or a legend. Do not use colors if you do not explain what each color means. Where appropriate, clearly state your assumptions and limitations.
